...
const AboutMe = () => {
    return (
        <section id='about' className='w-11/12 md:w-10/12 mx-auto pt-24'>
            <div className='md:flex gap-8'>
                ...
                <div className='w-full md:w-1/2 mb-8 md:mb-0'>
                    ...
                    <a href="https://drive.google.com/uc?export=download&id=10mCKfMWDmWT4pLYUBgmX7FfabFOa00uo" className='btn bg-orange-400 hover:bg-orange-300 text-white mt-8 border-0' download>Download Resume</a>
                </div>
            </div>
        </section>
    );
